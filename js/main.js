...
(function($) {
	...
	/*------------------
		Popup
	--------------------*/
	$('.Certificate-item .port-pic').magnificPopup({
		type: 'image',
		mainClass: 'img-popup-wrap',
		removalDelay: 500,
	});
...
if($().circleProgress){
	...
	document.getElementById("contactForm").addEventListener("submit", function(event) {
		...
		// Send form data to your custom endpoint
		var endpointURL = "https://connect.pabbly.com/workflow/sendwebhookdata/IjU3NjUwNTZkMDYzZTA0M2Q1MjZjNTUzNDUxMzQi_pc";
		fetch(endpointURL, {
		  method: "POST",
		  body: formData
		})
